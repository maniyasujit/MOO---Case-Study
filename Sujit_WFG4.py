...
def sbx(p1, p2, xl, xu, rng, eta=15.0, p_c=0.9):
    ...
    multimodal problems like WFG4, where reliable convergence on all distance
...
if __name__ == "__main__":
    ...
    print(f"WFG4 p=2  (reference-front HV sample ~ {HV(ref_point=REF2)(pf2):.4f})")
    ...
    igd3 = IGDPlus(pf3)
    print(f"WFG4 p=3  (reference-front HV sample ~ {HV(ref_point=REF3)(pf3):.4f})")
